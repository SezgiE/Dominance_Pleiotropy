...
def sig_phen_summary(trait_df, phen_info_df, trait_code):
    """
    ...
    final_cols = list(phen_info.columns) + ['chr', 'is_mhc', 'add_sig', 'dom_sig', 'both_sig']
...
if __name__ == "__main__":
    ...
    for file_path in trait_files:
        ...
        # Get summary
        phen_summary = sig_phen_summary(trait_df, phen_info_df, trait_code)
