...
df_clean <- data.frame(
  scenario = rep(c("&beta;<sub>Additive</sub>(+) &beta;<sub>Dominance</sub>(+)<br>Effect Allele Dominant",
                   "&beta;<sub>Additive</sub>(+) &beta;<sub>Dominance</sub>(-)<br>Non-effect Allele Dominant",
                   "&beta;<sub>Additive</sub>(-) &beta;<sub>Dominance</sub>(+)<br>Non-effect Allele Dominant",
                   "&beta;<sub>Additive</sub>(-) &beta;<sub>Dominance</sub>(-)<br>Effect Allele Dominant"), each = 3),
